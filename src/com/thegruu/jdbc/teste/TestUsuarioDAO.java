...
//	
	private static void testBuscarPorId(){
		...
		if(usu != null){
			System.out.println(usu.getId() + " - " + usu.getNome() + " - " + usu.getSobrenome() + " - " + usu.getApelido() + " - " + usu.getNascimento() + " - " + usu.getSexo() + " - " + usu.getCidade() + " - " + usu.getEmail() + " - " + usu.getSenha() + " - " + usu.getFoto());
		}else{
